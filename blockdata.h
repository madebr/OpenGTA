...
namespace OpenGTA {
  struct BlockData {
    ...
    BlockData(const BlockData &copy) = delete;
    BlockData& operator=(const BlockData &copy) = delete;
  private:
    BlockData() = default;
    ~BlockData() = default;
  };
...
#define SLOPE_RAW_DATA  OpenGTA::BlockData::Instance().slope_raw_data
#define SLOPE_TEX_DATA  OpenGTA::BlockData::Instance().slope_tex_data
#define LID_NORMAL_DATA OpenGTA::BlockData::Instance().lid_normal_data
